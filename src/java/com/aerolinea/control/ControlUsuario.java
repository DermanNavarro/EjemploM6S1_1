...
public class ControlUsuario {
    ...
    public String login(@RequestParam("txtUsuario")String usuario,
        ...
        if (usuariologueado!=null){
            ...
            return "redirect:/home/'Error en logueo'";
        }
    }
    ...
    public String addUsuario(@Valid @ModelAttribute("userForm")Usuario u, BindingResult result){
        if(result.hasErrors())
            return "registrarse";
    ...
    public String delUsuario(@PathVariable("id")String id){
        try {
    ...
    @RequestMapping ("/modUsuario/{id}")
    public ModelAndView verUsuario(@PathVariable("id")String id){
